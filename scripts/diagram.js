...
$('#diagram').html('<div id=diagramBar class=popuplinks>'+
						'<ul>'+
							'<li><a href="#" onclick="diagramSpeed()" class=link>Geschwindigkeit</a></li>'+
							'<li><a href="#" onclick="diagramCO2()" class=link>CO2-Aussto&szlig;</a></li>'+
							'<li><a href="#" onclick="diagramConsumption()" class=link>Spritverbrauch</a></li>'+
							'<li><a href="#" onclick="diagramMAF()" class=link>MAF</a></li>'+
							'<li><a href="#" onclick="diagramCarType()" class=link>Fahrzeugtypen</a></li>'+
						'</ul>'+
					'</div>'+
...
var maxResult_low_speed = Math.max(result_low_speed[0],result_low_speed[1],result_low_speed[2],result_low_speed[3],result_low_speed[4],
result_low_speed[5],result_low_speed[6],result_low_speed[7],result_low_speed[8],result_low_speed[9],result_low_speed[10],
result_low_speed[11],result_low_speed[12],result_low_speed[13],result_low_speed[14],result_low_speed[15],result_low_speed[16]);
...
var maxResult_high_speed = Math.max(result_high_speed[0],result_high_speed[1],result_high_speed[2],result_high_speed[3],result_high_speed[4],
result_high_speed[5],result_high_speed[6],result_high_speed[7],result_high_speed[8],result_high_speed[9],result_high_speed[10],
result_high_speed[11],result_high_speed[12],result_high_speed[13],result_high_speed[14],result_high_speed[15],result_high_speed[16]);
